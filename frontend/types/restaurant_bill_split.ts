...
export type RestaurantBillSplit = {
  version: "0.1.0";
...
export type BillAccount = IdlAccounts<RestaurantBillSplit>["billAccount"];
export type ParticipantAccount = IdlAccounts<RestaurantBillSplit>["participantAccount"]; 